        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 px-5">
            <div class="md:flex md:items-center md:justify-between">
                <div class="flex-1 min-w-0">
                    <h1 class="py-0.5 text-2xl font-semibold text-gray-900">{{ $t('Brands') }}</h1>
                </div>
                <div class="mt-4 flex md:mt-0 md:ml-4">
                    <router-link
                        class="btn btn-gray shadow-sm rounded-md"
                    ...
                    <router-link
                        ...
                        to="/dashboard/admin/stock/brands/new"
                    >
                        {{ $t('Create Brand') }}
                    </router-link>
                </div>
                    ...
                    <ul>
                        <template v-for="(brand, index) in brandList">
                            <li :class="{'border-t border-gray-200': index !== 0}">
                                <router-link
                                    :to="'/dashboard/admin/stock/brands/' + brand.id + '/edit'"
