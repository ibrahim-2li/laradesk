                            ...
                            <div class="flex rounded-md shadow-sm">
                                ...
                                <div class="relative inline-flex rounded-none">
                                    <select
                                        ...
                                        @change="getStock"
                                    >
                                        <option :value="null">{{ $t('All Brands') }}</option>
                                ...
                                <div class="relative inline-flex rounded-r-md">
                                    ...
                                    >
                                        ...
                                        <option value="brand_id">{{ $t('Status') }}</option>
                            ...
                            <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                                <table class="min-w-full  divide-y divide-gray-200">
                                    ...
                                    <template v-for="stock in stockList">
                                        <router-link
                                            :to="'/dashboard/admin/stock/' + stock.id +'/edit'"
                                        ...
                                        >
                                            ...
                                            <td class="px-6 py-4 whitespace-no-wrap leading-5">
                                                <div class="text-s text-gray-800">
                                                    {{ stock.created_at | momentFormatDate }}
                                                </div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-no-wrap leading-5">
                                                <div class="text-s text-gray-800">
                                                    {{ stock.updated_at | momentFormatDateTimeAgo }}
                                                </div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-no-wrap leading-5">
...
export default {
    ...
    methods: {
        ...
        getStock() {
            const self = this;
            self.loading = true;
            axios.get('api/dashboard/admin/stocks', {
                params: {
                    page: self.page,
                    sort: self.sort,
                ...
                self.stockList = response.data.items;
