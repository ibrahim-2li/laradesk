            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 px-5">
                <div class="md:flex md:items-center md:justify-between">
                    <div class="flex-1 min-w-0">
                        <h1 class="py-0.5 text-2xl font-semibold text-gray-900">{{ $t('Edit branches') }}</h1>
                    </div>
                                ...
                                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                    ...
                                    <div class="mt-2">
                                        <p class="text-sm leading-5 text-gray-500">
                                            {{ $t('Are you sure you want to delete the branches?') }}
                                            {{ $t('All data will be permanently removed') }}.
                                            {{ $t('Tickets with this branches will be changed to "Without branches"') }}.
...
export default {
    ...
    metaInfo() {
        return {
            title: this.$i18n.t('Edit branche')
        }
    },
    data() {
        return {
    ...
    methods: {
        ...
        deleteBranche() {
            ...
            axios.delete('api/dashboard/admin/branches/' + self.$route.params.id).then(function () {
                ...
                self.$router.push('/dashboard/admin/branches');
            }).catch(function (error) {
