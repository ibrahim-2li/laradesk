                ...
                @foreach ($replies as $reply)
                    <div class="flex {{ $reply->user_id === $ticket->user_id ? 'justify-start' : 'justify-end' }}">
                        <div
                            ...
                            <div
                                class="px-5 py-3.5 rounded-2xl shadow-sm text-sm border {{ $reply->user_id === $ticket->user_id ? 'bg-white text-gray-800 rounded-tl-none border-gray-100' : 'bg-blue-600 text-white rounded-tr-none border-blue-600' }}">
                                <div
        ...
        <div class="lg:col-span-1 space-y-6">
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="p-4 border-b border-gray-100 bg-gray-50/50">
                    <h3 class="text-sm font-bold text-gray-900">{{ __('Ticket Details') }}</h3>
                </div>
