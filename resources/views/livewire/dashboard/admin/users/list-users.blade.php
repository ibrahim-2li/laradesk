<div>
    <div class="bg-white rounded-[4px] shadow-sm border border-gray-100 mt-20">
        <div class="px-6 py-5 border-b border-gray-100 flex justify-between items-center">
            <h2 class="text-xl font-semibold text-gray-700">{{ __('Users') }}</h2>
            ...
            <div class="flex gap-4">
                ...
                <div class="w-40">
                    <select wire:model.live="roleFilter"
                        class="w-full pl-3 pr-10 py-2 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-300 bg-white">
                ...
                <tbody class="divide-y divide-gray-50">
                    @forelse($users as $user)
                        <tr class="hover:bg-gray-50/50 transition-colors group">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 h-10 w-10">
                                        <img class="h-10 w-10 rounded-full ring-2 ring-white object-cover"
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span
                                    class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-[4px] bg-blue-50 text-blue-700 border border-blue-100">
                                    {{ $user->userRole->name ?? __('No Role') }}
                                </span>
                            </td>
            ...
            <div class="bg-white rounded-lg shadow-xl w-full max-w-lg mx-4">
                <div class="px-6 py-4 border-b">
                    <h3 class="text-lg font-semibold text-gray-900">
                        {{ $editingId ? __('Edit User') : __('Create New User') }}
                    </h3>
                </div>
                    ...
                    <div class="px-6 py-4 space-y-4">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700">
                                ...
                                @if ($editingId)
                                    <span
                                        class="text-xs text-gray-500">({{ __('Leave blank to keep current') }})</span>
                                @endif
                            </label>
                        ...
                        <div class="flex items-center">
                            <input wire:model="status" type="checkbox"
                                ...
                                value="1">
                            <label class="ml-2 block text-sm text-gray-900">{{ __('Active') }}</label>
                        </div>
                    </div>
