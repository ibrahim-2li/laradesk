<div>
    <div class="mb-6 flex justify-between items-center">
        <h1 class="text-2xl font-bold text-gray-800">{{ __('Priorities') }}</h1>
        ...
        <div class="p-4 border-b border-gray-200">
            <div class="w-full md:w-1/3">
                <input wire:model.live.debounce.300ms="search" type="text"
                    placeholder="{{ __('Search priorities...') }}"
                    ...
                    @forelse($priorities as $priority)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <button wire:click="edit({{ $priority->id }})"
                                    class="text-blue-600 hover:text-blue-900 mr-3">{{ __('Edit') }}</button>
                                <button wire:click="delete({{ $priority->id }})"
                                    wire:confirm="{{ __('Are you sure you want to delete this priority?') }}"
