<div>
    <div class="mb-8 flex flex-col md:flex-row md:justify-between md:items-center gap-4">
        <div>
            <h1 class="text-3xl font-bold tracking-tight text-gray-900">{{ __('My Orders') }}</h1>
            <p class="text-sm text-gray-500 mt-1">{{ __('Track and manage your order requests.') }}</p>
        </div>
                    ...
                    @forelse($orders as $order)
                        <tr class="hover:bg-gray-50 transition duration-150 ease-in-out">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium text-gray-900">{{ $order->subject }}</div>
                                <div class="text-xs text-gray-500 font-mono mt-0.5">#{{ $order->id }}</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span
                        ...
                        <tr>
                            <td colspan="5" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center">
                                    ...
                                    <span class="text-gray-500 text-sm">{{ __('No orders found.') }}</span>
                                </div>
                            </td>
                        </tr>
                    @endforelse
