<div>
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden mt-20">
        <div
            ...
            <div>
                <h3 class="text-lg font-bold text-gray-900">{{ __('My Tickets') }}</h3>
            </div>
                        ...
                        <tr class="hover:bg-gray-50 transition duration-150 ease-in-out group">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex flex-col">
                                    <span class="text-sm font-bold text-gray-700">{{ $ticket->subject }}</span>
                                    <span class="text-xs text-gray-400 font-mono mt-0.5">#{{ $ticket->id }}</span>
                                </div>
                            </td>
                                ...
                                <div class="flex justify-center -space-x-2">
                                    @if ($ticket->agent)
                                        <img class="inline-block h-8 w-8 rounded-full ring-2 ring-white border border-gray-100 object-cover"
                                            ...
                                            alt="{{ $ticket->agent->name }}" title="{{ $ticket->agent->name }}">
                                    @else
                                        <span
