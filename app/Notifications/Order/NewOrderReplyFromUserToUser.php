...
class NewOrderReplyFromUserToUser extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->line(__('We have received your response to the order, we will try to respond as soon as possible, you can see the details in this link').':')
